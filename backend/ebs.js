...
process.env.EXT_SECRET = 'TVh0KsSa+33ueBFzr+u1HnwLyUOUVmUYg+8FDYRNzkE=';
process.env.EXT_CLIENT_ID = 'x86ty440ze5dpu9lw7kdzq1xwmqf5t';
...
function testingHandler(req){
  console.log('recieved testing handler request');
  return 'works'
}
